...
String check_data::parseData(String &_inputString, byte _UNIT_ID, data_channel _local_my_sensor_data[])
{
  ...
  // What is ID?:                       "aaI0ID?#" also mentioned at start up of unit - its solder-programmed... cannot be changed in code.
  ...
  // aaFAIL3: 
  // aaFAIL4: 
  // aaFAIL5: No aa and # on the string     
      ...
      && _inputString.charAt(_inputString.length() - 2) == '#')
  {
    ...
    {
      _outputString = fail_string + "1";   // String is too long
    }
    else
    {
