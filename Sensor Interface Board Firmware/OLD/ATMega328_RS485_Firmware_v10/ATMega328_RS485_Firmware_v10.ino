...
void checkSensorData(int _channel_number) {
  ...
  switch (my_sensor_data[j].data_send_time) {
    case 0:
      my_sensor_data[_channel_number].data_1s_holder += getSensorData();
      break;
    case 1:
      my_sensor_data[_channel_number].data_10s_holder += getSensorData();
      break;
    case 2:
      my_sensor_data[_channel_number].data_60s_holder += getSensorData();
      break;
    case 3:
      my_sensor_data[_channel_number].data_600s_holder += getSensorData();
      break;
    case 4:
      my_sensor_data[_channel_number].data_3600s_holder += getSensorData();
      break;
    default:
#ifdef DEBUG_FLAG
...
float getSensorData() {
  ...
  digitalWrite(HC12_PWR_PIN, LOW);  // Switch off power
  return (456.7);
}
...
void tap(Button2& btn) {
  ...
  if (btn == buttonA) {
    ...
    returnString += (String)send_sensor_data;
