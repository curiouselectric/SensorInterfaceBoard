/*
   ...
   This code is for an ATMega328 base.
   Different boards have been created:
   1 is designed to read RS485 sensor devices, store and average the data and then return the data based on simple serial commands.
   1 is designed for wind speed sensors and wind vanes
   1 is designed for Solar irradiance measurements.
